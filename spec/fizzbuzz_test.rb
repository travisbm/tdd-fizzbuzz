...
class FizzBuzzTest < Minitest::Test
  ...
  def test_buzz_returns_for_div_by_5_number
    fb = Fizzbuzz.new
  ...
  def test_buzz_returns_given_number
    fb = Fizzbuzz.new
    assert_equal((4), fb.buzz(4))
  end

  def test_fizzbuzz_returns_for_div_by_15_numbers
    fb = Fizzbuzz.new
  ...
  def test_fizzbuzz_returns_given_number
    fb = Fizzbuzz.new
    assert_equal((14), fb.fizzbuzz(14))
  end
  ...
  def test_fizzbuzz_works
    fb = Fizzbuzz.new
    assert_equal([1, 2, 'fizz', 4, 'buzz',
                'fizz', 7, 8, 'fizz', 'buzz',
                11, 'fizz', 13, 14, 'fizzbuzz'], fb.run(15))
  end
